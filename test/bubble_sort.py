...
def myswap(arr, index1, index2):
    arr[index1], arr[index2] = arr[index2], arr[index1]

@bigO.track(lambda collection: len(collection))
...
if __name__ == "__main__":
    ...
    for i in range(10):
        unsorted = sample(range(-100 * (i+1), 100 * (i+1)), 200 * (i+1))
